...
class Triangle extends Shapes {
    ...
    render() {
        ...
        <text font-size="50" x="50%" y="55%" dominant-baseline="middle" text-anchor="middle" fill="${this.textColour}">${this.text}</text>
        </svg>`
    }
}
...
class Circle extends Shapes {
    ...
    render () {
        ...
        <text font-size="50" x="35%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="${this.textColour}">${this.text}</text>
        </svg>`
    }
}
...
class Square extends Shapes {
    ...
    render () {
        ...
        <text font-size="50" x="37%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="${this.textColour}">${this.text}</text>
        </svg>`
    }
}
