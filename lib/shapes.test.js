...
describe ("Shapes", () => {
    ...
    describe("triangle", () => {
        ...
        <text font-size="50" x="50%" y="55%" dominant-baseline="middle" text-anchor="middle" fill="red">ABC</text>
        </svg>`
    ...
    describe("circle", () => {
        ...
        <text font-size="50" x="35%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="black">LOL</text>
        </svg>`
